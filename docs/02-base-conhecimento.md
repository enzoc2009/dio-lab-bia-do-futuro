...
> Me ajude a: (1) entender o que cada arquivo contém, (2) decidir como usar cada um, (3) criar um exemplo do contexto formatado para incluir no prompt.
> ```

## Dados Utilizados

| Arquivo | Formato | Para que serve na Ajuda-Finança? |
|---------|---------|---------------------|
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas da Ajuda-Finança de forma mais assertiva.
...
[
  ...
  },
  {
    ...
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "Dividend Yield (DY) de 0,6% a 0,95% ao mês, ou cerca de 11,5% ao ano",
    "aporte_minimo": 100.00,
